package com.esri.android.plantr.ble;
...
public class KnownUUIDs extends StandardUUIDs {
    ...
    static {
        ...
        aMap.put("6e400003-b5a3-f393-e0a9-e50e24dcca9e".toUpperCase(), "RX Buffer");
        aMap.put("6e400002-b5a3-f393-e0a9-e50e24dcca9e".toUpperCase(), "TX Buffer");
